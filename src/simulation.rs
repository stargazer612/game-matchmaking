...
pub fn run_simulation(
    ...
    println!("Starting simulation with {} players, concurrency {}, rate {:.2} p/s", total_players, concurrency, players_per_second);
...
mod tests {
    ...
    fn test_skill_distribution_is_centered_around_1500() {
        ...
        assert!(
            ...
            "Mean {:.1} is too far from 1500", mean
        );
